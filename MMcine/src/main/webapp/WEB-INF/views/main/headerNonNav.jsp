...
<link href="${conPath }/css/headerNonNav.css" rel="stylesheet">
<!-- slick Thema -->
...
<body>
	<div id="head_wrap">
				...
				<div id="gnb">
					<div id="gnb_logo_div">
						<a href="${conPath }/main.do"><img
							src="${conPath }/img/logo.png" alt="logo" id="logo_img"></a>
					</div>
					<ul>
						...
						<li><a href="#">게시판</a>
							<div id="loginAfter_window">
								<form action="#" method="get">
									<div id="my_grade">
										<!-- 회원등급 조인해서 등급받아오기 -->
										<h3>${SessionCustomer.cusId}님환영합니다.</h3>
										<p>${SessionCustomer.cusName }님의
											고객등급은 <span
										...
										class="vvip"
									</c:if>>${SessionCustomer.cusGrade }</span>
											입니다.
										</p>
									...
									<div id="my_point">
										<p>${SessionCustomer.cusName }님포인트:
											${SessionCustomer.cusPoint }p</p>
										<p>${SessionCustomer.cusName }님구매누적금액:
											${SessionCustomer.cusSum }원</p>
									</div>
									<div id="all_info">
										<!-- 나의 메가맥스 -->
										<div id="my_info">
											<img
												src="${conPath }/customerPhoto/${SessionCustomer.cusPhoto }"
												alt="megamax" id="customer_photo1"
												onclick="location.href='${conPath }/main.do'" />
											<p class="info_font"
												onclick="location.href='${conPath }/main.do'">나의 메가맥스</p>
										</div>
										<!-- 예매현황 -->
										<div id="ticket_info">
											<img src="${conPath }/img/ticketImg.png" alt="ticketConfirm"
												id="customer_photo1"
												onclick="location.href='${conPath }/main.do'" />
											<p class="info_font"
												onclick="location.href='${conPath }/main.do'">예매확인/취소</p>
										</div>
										<!-- 스토어내역 -->
										<div id="store_info">
											<img src="${conPath }/img/storeImg.png" alt="storeHistory"
												id="customer_photo1"
												onclick="location.href='${conPath }/main.do'" />
											<p class="info_font"
												onclick="location.href='${conPath }/main.do'">스토어 구매내역</p>
										</div>
									</div>
									<div id="logout_back">
										<input id="my_modify_btn" type="button" value="정보수정"
											onclick="location.href='${conPath}/modify_view.do'">
										<input id="logout_btn" type="button" value="로그아웃"
											onclick="location.href='${conPath}/logout.do'">
									</div>
								</form>
							</div></li>
						<li><img
							src="${conPath }/customerPhoto/${SessionCustomer.cusPhoto }"
							alt="${SessionCustomer.cusPhoto }" id="customer_photo"> <a
							href="#" id="loginAfter_btn">${SessionCustomer.cusName }님&nbsp;&nbsp;<img
								src="${conPath }/img/1.png" alt="infomation" /></a></li>
					</ul>
				</div>
			</div>
		</c:if>
		...
		<!-- 	로그인전메뉴 -->
		<c:if test="${empty SessionCustomer and empty SessionAdmin }">
			<div id="gnb_wrap">
				<div id="gnb">
					<div id="gnb_logo_div">
						<a href="${conPath }/main.do"><img
								...
								<div id="login_form">
									<form action="${conPath }/login.do" method="post">
										<div id="login_input_id">
											<input type="text" name="cusId" required="required"
												placeholder="아이디">
										</div>
										<div id="login_input_pw">
											<input type="password" name="cusPw" required="required"
												placeholder="비밀번호">
										</div>
										<div id="login">
		...
		<div>
			<div id="snb_wrap">
				<div id="snb">
					...
					<div id="snb_right">
						<a href="${conPath}/screenList.do">상영시간표</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="myModal1" class="modal1">
			...
			<div class="modal-content">
				<div id="modal-content-left">
					<h4>영화</h4>
					<p>
						<a href="${conPath }/movieOpen.do">최신 개봉작</a>
					</p>
					<p>
						<a href="#">현재 상영작</a>
					</p>
				...
				<div id="modal-content-right">
					...
					<p>
      					<a href="${conPath }/notice.do">공지 게시판</a>
					</p>
				</div>
