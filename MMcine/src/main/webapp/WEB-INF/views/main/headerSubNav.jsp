...
<link href="${conPath }/css/headerSubNav.css" rel="stylesheet">
<!-- slick thema -->
...
<div id="head_wrap">
    ...
    <div id="subNav">
    	<div id="subNav_nav">
    		<ul>
    			<li><a href="${conPath }/movieListPage.do">박스오피스</a></li>
    			<li><a href="${conPath }/movieOpen.do">최근개봉작</a></li>
    			<li><a href="${conPath }/movieExpected.do">개봉예정작</a></li>
    			<li><a href="${conPath }/movieDatabase.do">영화DB</a></li>
    		</ul>
    	</div>
    </div>
</div>
