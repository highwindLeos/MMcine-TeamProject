...
<div id="writeForm">
<form action="${conPath }/writeNotice.do" method="POST" enctype="multipart/form-data" >
<input type="hidden" name="pageNum" value="${paging.currentPage }" />
<input type="hidden" name="nBoardId" value="${SessionAdmin.aId }" />
<table>
	<tr>
		<th colspan="2"><h3>공지사항 등록 </h3></th>
	</tr>
	<tr>
		<td><h4>공지 제목</h4></td>
		<td><input type="text" name="nBoardTitle" required="required"/></td>
	</tr>
	<tr>
		<td><h4>공지 내용</h4></td>
		<td>
			<textarea name="nBoardContent"></textarea>
		</td>
	</tr>
	<tr>
